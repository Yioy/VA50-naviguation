...
"""autogenerated by genpy from visualization/VizUpdate.msg. Do not edit."""
import codecs
import sys
...
class VizUpdate(genpy.Message):
  _md5sum = "941d9f8831c96e39004fc0238179a21d"
  _type = "visualization/VizUpdate"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VizUpdate, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_i3I().pack(_x.id, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
