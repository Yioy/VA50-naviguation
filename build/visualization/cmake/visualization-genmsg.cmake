...
set(MSG_I_FLAGS "-Ivisualization:/home/arusso/dev/VA50-naviguation/src/visualization/msg;-Isensor_msgs:/opt/ros/noetic/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/arusso/dev/VA50-naviguation/src/visualization/msg/VizUpdate.msg" NAME_WE)
add_custom_target(_visualization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "visualization" "/home/arusso/dev/VA50-naviguation/src/visualization/msg/VizUpdate.msg" "sensor_msgs/Image:std_msgs/Header"
)
...
_generate_msg_cpp(visualization
  "/home/arusso/dev/VA50-naviguation/src/visualization/msg/VizUpdate.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/visualization)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/visualization\")")
  # install generated code
  install(
