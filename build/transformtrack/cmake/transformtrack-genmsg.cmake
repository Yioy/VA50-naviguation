...
get_filename_component(_filename "/home/arusso/dev/VA50-naviguation/src/transformtrack/srv/DropVelocity.srv" NAME_WE)
add_custom_target(_transformtrack_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "transformtrack" "/home/arusso/dev/VA50-naviguation/src/transformtrack/srv/DropVelocity.srv" ""
)

get_filename_component(_filename "/home/arusso/dev/VA50-naviguation/src/transformtrack/srv/TransformBatch.srv" NAME_WE)
add_custom_target(_transformtrack_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "transformtrack" "/home/arusso/dev/VA50-naviguation/src/transformtrack/srv/TransformBatch.srv" "std_msgs/Float64MultiArray:std_msgs/MultiArrayLayout:std_msgs/MultiArrayDimension"
)
